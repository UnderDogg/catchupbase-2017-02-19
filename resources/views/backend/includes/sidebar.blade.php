    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Active::pattern('admin/dashboard') }}"><a
                        href="{!!route('admin.dashboard')!!}"><span>{{ trans('menus.dashboard') }}</span></a></li>
            ...
            <li class="{{ Active::pattern('admin/tax*') }} treeview">
                ...
                <ul class="treeview-menu {{ Active::pattern('admin/sale*', 'menu-open') }}"
                    style="display: none; {{ Active::pattern('admin/tax*', 'display: block;') }}">
                    <!--  Sales -->
                    <li class="{{ Active::pattern('admin/esale*') }} treeview">
                        ...
                        <ul class="treeview-menu {{ Active::pattern('admin/sale*', 'menu-open') }}"
                            style="display: none; {{ Active::pattern('admin/check_out_agreement*', 'display: block;') }}">
                    ...
                    <li class="{{ Active::pattern('admin/eav*') }} treeview">
                        ...
                        <ul class="treeview-menu {{ Active::pattern('admin/catalog*', 'menu-open') }}"
                            style="display: none; {{ Active::pattern('admin/check_out_agreement*', 'display: block;') }}">
                            ...
                            <li class="{{ Active::pattern('admin/eav*') }} treeview">
                                ...
                                <ul class="treeview-menu {{ Active::pattern('admin/eav/*', 'menu-open') }}"
                                    style="display: none; {{ Active::pattern('admin/check_out_agreement*', 'display: block;') }}">
                                    <li class="{{ Active::pattern('admin/bank_transfer_info') }}">
                    ...
                    <li class="{{ Active::pattern('admin/check_out_agreement*') }} treeview">
                        ...
                        <ul class="treeview-menu {{ Active::pattern('admin/check_out_agreement*', 'menu-open') }}"
                            style="display: none; {{ Active::pattern('admin/check_out_agreement*', 'display: block;') }}">
                            <li class="{{ Active::pattern('admin/bank_transfer_info') }}">
