                ...
                <div class="tab-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" name="name" class="form-control"
                                       placeholder="{{ trans('validation.attributes.permission_name') }}"
                                       {{$permission->system == 1 ? 'readonly' : ''}} value="{{$permission->name}}"/>
                            </div>
                        </div><!--form control-->
                    ...
                    <div role="tabpanel" class="tab-pane" id="dependencies" style="padding-top:20px">
                        ...
                        <div class="alert alert-info">
                            ...
                            For example: This permission may be <strong>create-user</strong>, but if the user doesn't
                            also have <strong>view-backend</strong> and <strong>view-access-management</strong>
                            permissions they will never be able to get to the <strong>Create User</strong> screen.
                        </div><!--alert-->
                                                ...
                                                @foreach ($perm as $p)
                                                    ...
                                                    @if ($p['id'] != $permission->id)
                                                        <li><input type="checkbox" value="{{$p['id']}}"
                                                                   ...
                                                                   id="permission-{{$p['id']}}" {!! in_array($p['id'], $permission_dependencies) ? 'checked' : '' !!} />
